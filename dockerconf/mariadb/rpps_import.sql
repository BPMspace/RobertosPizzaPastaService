...
(6730, 'Pizza', ' Margerita', 'Dough Tomatoes Mozzarella  Basil ', '599.00', 380),
(6731, 'Pizza', ' Proscuitto', 'Dough Tomatoes Mozzarella  Cooked Ham ', '799.00', 415),
(6732, 'Pizza', ' Salami', 'Dough Tomatoes Mozzarella  Salami', '799.00', 425),
(6733, 'Pizza', ' Funghi', 'Dough Tomatoes Mozzarella  Mushrooms ', '799.00', 435),
(6734, 'Pizza', ' Papa', 'Dough Tomatoes Mozzarella Tuna Onions  Garlic', '1299.00', 453),
(6735, 'Pizza', ' Diavolo', 'Dough Tomatoes Mozzarella Salami Peppers  Hot Peppers', '1299.00', 460),
(6736, 'Pizza', ' Regina', 'Dough Tomatoes Mozzarella Cooked Ham  Mushrooms', '999.00', 480),
(6737, 'Pizza', ' Mista', 'Dough Tomatoes Mozzarella Salami Cooked Ham  Mushrooms ', '1099.00', 535),
(6738, 'Pizza', ' Hawaii', 'Dough Tomatoes Mozzarella Cooked Ham  Pineapple', '1099.00', 443),
(6739, 'Pizza', ' Tonno', 'Dough Tomatoes Mozzarella Tuna  Onions ', '1099.00', 431),
(6740, 'Pizza', ' Grandiosa', 'Dough Tomatoes Mozzarella Cooked Ham Salami Mushrooms Peppers Artichokes  Onions ', '1599.00', 617),
(6741, 'Pizza', ' Pesto', 'Dough Tomatoes Mozzarella Pesto', '699.00', 377),
(6742, 'Pasta', 'Aglio & Olio', 'Pasta Basil  Garlic', '74.00', 232),
(6743, 'Pasta', 'Tonno ', 'Pasta Tuna  Onions', '114.00', 261),
(6744, 'Pasta', 'Funghi', 'Pasta Mushrooms  Basil', '77.00', 275),
(6745, 'Pasta', 'Pesto ', 'Pasta  Pesto', '71.00', 217),
(6746, 'Basic', 'Dough', '', '0.00', 250),
(6747, 'Basic', 'Pasta', '', '0.00', 200),
(6748, 'Extra', 'Tomatoes', '', '12.00', 70),
(6749, 'Extra', 'Mozzarella', '', '22.00', 50),
(6750, 'Extra', 'Basil', '', '9.00', 10),
(6751, 'Extra', 'Cooked Ham', '', '22.00', 45),
(6752, 'Extra', 'Salami', '', '21.00', 55),
(6753, 'Extra', 'Mushrooms', '', '14.00', 65),
(6754, 'Extra', 'Peppers ', '', '16.00', 25),
(6755, 'Extra', 'Hot Peppers', '', '15.00', 10),
(6756, 'Extra', 'Artichokes', '', '19.00', 30),
(6757, 'Extra', 'Onions', '', '11.00', 27),
(6758, 'Extra', 'Pineapple', '', '18.00', 28),
(6759, 'Extra', 'Tuna', '', '27.00', 34),
(6760, 'Extra', 'Pesto', '', '26.00', 17),
(6761, 'Extra', 'Garlic', '', '11.00', 22);

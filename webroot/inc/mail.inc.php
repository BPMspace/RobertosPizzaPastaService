...
echo $sanitized['subject']."<br>";
echo $sanitized['message']."<br>";
echo $sanitized['kitchen']."<br>";
echo $sanitized['driver']."<br>";
echo $sanitized['redirect']."<br>";
echo $sanitized['from']."<br>";
exit;
$msg = '';
